...
function king_ajax_salt(){
	...
	$s="<a href=\"javascript:;\" class=\"k_ajax\" title=\"".$king->lang->get('system/check/verifynew')."\" rel=\"{URL:'../system/verify.php',ID:'{$id_fly}',CMD:'salt'}\"><img alt=\"".$king->lang->get('system/check/verifynew')."\" src=\"".$king->config('inst')."system/verify.php?salt={$salt}\"/></a>";
	$s.="<a href=\"javascript:;\" style=\"display:none\" class=\"k_ajax\" rel=\"{URL:'../system/verify.php',ID:'{$id_fly}',CMD:'salt'}\">".$king->lang->get('system/check/verifynew')."</a>";
	kc_ajax('',$s,0,$js);
}
